    ...
    return(
      ...
      <div class="options">
        ...
        <div class="cart-icon" onclick="cartToggle()">
          <img class="shopping-icon" src="./crown_theme/assets/shopping-bag.svg" alt="" />
        </div>
...
export default CrownStaticPage_71;
